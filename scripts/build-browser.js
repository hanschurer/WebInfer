...
async function build() {
  try {
    ...
    await esbuild.build({
      ...
      bundle: true,
      format: 'esm',
      outfile: join(rootDir, 'dist/WebInfer.browser.js'),
      platform: 'browser',
      target: ['es2020'],
      sourcemap: true,
      minify: false,
    ...
    await esbuild.build({
      ...
      bundle: true,
      format: 'esm',
      outfile: join(rootDir, 'dist/WebInfer.browser.min.js'),
      platform: 'browser',
      target: ['es2020'],
      sourcemap: true,
      minify: true,
    ...
    console.log('  - dist/WebInfer.browser.js');
    console.log('  - dist/WebInfer.browser.min.js');
  } catch (error) {
