 ...
 * Inspect a tensor
 */
export declare function inspectTensor(tensor: WebInferTensor, name?: string, options?: {
    histogram?: boolean;
    maxSample?: number;
}): TensorInspection;
/**
 ...
 */
export declare class WebInferDebugger {
    private config;
    private events;
    private traces;
     ...
     */
    inspectTensor(tensor: WebInferTensor, name?: string): TensorInspection;
    /**
 ...
 */
export declare function getDebugger(config?: DebuggerConfig): WebInferDebugger;
/**
 * Enable debugging
 */
export declare function enableDebugging(config?: DebuggerConfig): WebInferDebugger;
/**
 * Disable debugging
 */
 ...
 */
export declare function createTensorHeatmap(tensor: WebInferTensor, width?: number): string;
/**
...
declare const _default: {
    WebInferDebugger: typeof WebInferDebugger;
