 ...
 */
export declare function quantizeTensor(tensor: WebInferTensor, type: QuantizationType, options?: {
    symmetric?: boolean;
    perChannel?: boolean;
}): {
 ...
 */
export declare function dequantizeTensor(tensor: WebInferTensor, scale: number | number[], zeroPoint: number | number[], type: QuantizationType): WebInferTensor;
/**
 * Pruning options
 */
 ...
 */
export declare function pruneTensor(tensor: WebInferTensor, options?: PruningOptions): {
    tensor: WebInferTensor;
    mask: WebInferTensor;
    sparsity: number;
};
