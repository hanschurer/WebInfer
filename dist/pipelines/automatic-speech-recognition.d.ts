/**
 * WebInfer.js - Automatic Speech Recognition Pipeline
 *
...
export declare class AutomaticSpeechRecognitionPipeline extends BasePipeline<AudioInput | AudioInput[], ASRResult | ASRResult[]> {
     ...
     */
    protected preprocess(input: AudioInput | AudioInput[]): Promise<WebInferTensor[]>;
    /**
     * Postprocess model output
     */
    protected postprocess(outputs: WebInferTensor[], options?: PipelineOptions): Promise<ASRResult | ASRResult[]>;
    /**
