...
export declare class QuestionAnsweringPipeline extends BasePipeline<QAInput | QAInput[], QuestionAnsweringResult | QuestionAnsweringResult[]> {
     ...
     * Preprocess QA input
     */
    protected preprocess(input: QAInput | QAInput[]): Promise<WebInferTensor[]>;
    /**
     * Postprocess model output
     */
    protected postprocess(outputs: WebInferTensor[], _options?: PipelineOptions): Promise<QuestionAnsweringResult | QuestionAnsweringResult[]>;
}
