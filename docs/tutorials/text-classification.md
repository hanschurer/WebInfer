...
本教程将介绍如何使用 WebInfer.js 进行文本分类任务，如情感分析。
...
```typescript
import { preloadModel, pipeline } from 'WebInferjs';
...
<body>
  ...
  <script type="module">
    import { pipeline } from 'https://cdn.jsdelivr.net/npm/WebInferjs/dist/WebInfer.browser.min.js';
